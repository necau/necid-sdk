...
public class DeleteTagRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable, RequestSignerAware {
    ...
    public DeleteTagRequest name(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTagRequest == false)
            return false;
    ...
    public DeleteTagRequest clone() {
        return (DeleteTagRequest) super.clone();
    }
     ...
     */
    public DeleteTagRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
