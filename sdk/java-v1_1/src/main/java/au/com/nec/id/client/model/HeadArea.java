...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/api-1.1/HeadArea" target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HeadArea implements Serializable, Cloneable, StructuredPojo {
    ...
    public HeadArea bottom(String bottom) {
        setBottom(bottom);
        return this;
    }
    ...
    public HeadArea left(String left) {
        setLeft(left);
        return this;
    }
    ...
    public HeadArea right(String right) {
        setRight(right);
        return this;
    }
    ...
    public HeadArea top(String top) {
        setTop(top);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HeadArea == false)
            return false;
        HeadArea other = (HeadArea) obj;
    ...
    @Override
    public HeadArea clone() {
        try {
            return (HeadArea) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        au.com.nec.id.client.model.transform.HeadAreaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
