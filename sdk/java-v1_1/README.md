...
This compiles the client into a jar located at `./target/NECID-1.1.jar`. Note that this jar does not include any dependencies.
...
```perl
dependencies {
    compile 'au.com.nec.id.client:NECID:1.1'
}
```
...
<dependencies>
    <dependency>
        <groupId>au.com.nec.id.client</groupId>
        <artifactId>NECID</artifactId>
        <version>1.1</version>
    </dependency>
</dependencies>
```
...
This will compile the client and package all dependencies into a jar located at `./target/NECID-1.1.jar`.
